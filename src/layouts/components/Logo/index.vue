...
<template>
  <div class="layout-logo-container layout-mode-top" :class="{ collapse: props.collapse }">
...
.layout-logo-container {
  ...
  line-height: var(--cfm-header-height);
...
.layout-mode-top {
  ...
  line-height: var(--cfm-navigationbar-height);
}
